...
import { ProcedureForm, ProcedureFormOutput } from '../../entities/procedure-form.interface';
...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, InputComponent, ButtonComponent, NgIf],
...
export class ProcedureDetailsComponent {
  ...
  constructor(public route: ActivatedRoute, private procedureService: ProcedureService, private router: Router) {}
  ...
  ngOnInit(): void {
    ...
    this.formGroup = new FormGroup<ProcedureForm>({
      ...
      steps: new FormControl({ value: null, disabled: false }, [Validators.required]),
      member: new FormControl({ value: null, disabled: false }, [Validators.required]),
    })

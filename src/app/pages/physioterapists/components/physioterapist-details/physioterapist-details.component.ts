...
import { PhysioterapistForm, PhysioterapistFormOutput } from '../../entities/physioterapists-form.interface';
...
export class PhysioterapistDetailsComponent {
  ...
  constructor(public route: ActivatedRoute, private physioterapistService: PhysioterapistService, private router: Router) {}

  ngOnInit(): void {
    const formData = this.route.snapshot.data.formData as PhysioterapistFormOutput;

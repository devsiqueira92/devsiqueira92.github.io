...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, InputComponent, UploadComponent, LinkButtonComponent, NzGridModule],
...
export class RegisterComponent implements OnInit {
  ...
  register() {
    this.authenticationService.register(this.formGroup.getRawValue() as RegisterForm)
